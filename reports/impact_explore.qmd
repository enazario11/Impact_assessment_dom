...
# all_sf
# ggsave(here("figs/blue_ts/sf.png"), all_sf, height = 6, width = 7, units = c("in"), bg= 'transparent')
```
...
# all_socal
# ggsave(here("figs/blue_ts/socal.svg"), all_socal, height = 6, width = 7, units = c("in"),bg= 'transparent')
```
